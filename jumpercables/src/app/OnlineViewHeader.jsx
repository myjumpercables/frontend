...
export const OnlineViewHeader = (props) => {
    ...
    return(
        ...
        <div className="container col-2 d-flex justify-content-center align-items-center">
        ...
        <div className="col-2 text-white container d-flex justify-content-center align-items-center">
